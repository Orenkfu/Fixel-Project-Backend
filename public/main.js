...
module.exports = "<div class=\"panel\">\n  <h3>\n    Admin Panel\n  </h3>\n  <form #f=\"ngForm\" (ngSubmit)=\"findByName(f.value)\">\n    <input placeholder=\"Movie Name\" #name=\"ngModel\" ngModel name=\"name\" (keyup)=\"searchKeyUp()\" class=\"form-control\">\n    <button class=\"btn btn-primary\">Search In TMDB</button>\n    <button type=\"button\" class=\"btn btn-secondary\" (click)=\"clear()\">Clear Movies</button>\n    <div class=\"alert alert-danger\" *ngIf=\"noResults\">\n      No movies called {{name.value}} found in TMDB.\n    </div>\n  </form>\n  <div>\n    <div class=\"card-group\" *ngIf=\"movieResults\">\n      <div class=\"card\" style=\"width: 12rem;\" *ngFor=\"let movie of movieResults\">\n        <img class=\"card-img-top\" [src]=\"displayImage(movie.poster_path)\" [alt]=\"movie.title\">\n        <div class=\"card-body\">\n          <h5 class=\"card-title\">{{movie.title}}</h5>\n          <p class=\"card-text\">{{movie.overview | summary}}</p>\n        </div>\n        <div class=\"card-footer\">\n          <button (click)=\"addToStore(movie)\" class=\"btn btn-primary btn-block\">Add To Store</button>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"
...
/* harmony import */ var _services_tmdb_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../services/tmdb.service */ "./src/app/services/tmdb.service.ts");
...
var AdminPanelComponent = /** @class */ (function () {
    function AdminPanelComponent(tmdbService, moviesService) {
        this.tmdbService = tmdbService;
        this.moviesService = moviesService;
        this.posterUrl = 'http://image.tmdb.org/t/p/w185/';
        this.movieAdded = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
    }
    AdminPanelComponent.prototype.findByName = function (form) {
        var _this = this;
        console.log(form.name);
        this.tmdbService.getByName(form.name).subscribe(function (res) {
            console.log(res);
            if (res['results'].length == 0)
                _this.noResults = true;
            _this.movieResults = res['results'].slice(0, 5);
        });
    };
    AdminPanelComponent.prototype.searchKeyUp = function () {
        this.noResults = false;
    };
    AdminPanelComponent.prototype.clear = function () {
        this.noResults = false;
        this.movieResults = null;
    };
    AdminPanelComponent.prototype.addToStore = function (movie) {
        var _this = this;
        this.moviesService.createMovie(this.tmdbService.toLocalMovie(movie)).subscribe(function (response) {
            console.log('response from server to createMovie', response);
            _this.movieAdded.emit(response);
        });
    };
    //assets path is hard coded here
    AdminPanelComponent.prototype.displayImage = function (path) {
        if (path)
            return this.posterUrl + path;
        else
            return '../assets/default-movie.png';
    };
    ...
    ], AdminPanelComponent.prototype, "movieAdded", void 0);
    AdminPanelComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_tmdb_service__WEBPACK_IMPORTED_MODULE_1__["TmdbService"], _services_movies_service__WEBPACK_IMPORTED_MODULE_0__["MoviesService"]])
    ], AdminPanelComponent);
...
/* harmony import */ var _order_ticket_order_ticket_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./order-ticket/order-ticket.component */ "./src/app/order-ticket/order-ticket.component.ts");
...
/* harmony import */ var _services_tmdb_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/tmdb.service */ "./src/app/services/tmdb.service.ts");
/* harmony import */ var _single_movie_single_movie_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./single-movie/single-movie.component */ "./src/app/single-movie/single-movie.component.ts");
...
/* harmony import */ var _movie_cast_movie_cast_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./movie-cast/movie-cast.component */ "./src/app/movie-cast/movie-cast.component.ts");
...
/* harmony import */ var _admin_panel_admin_panel_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./admin-panel/admin-panel.component */ "./src/app/admin-panel/admin-panel.component.ts");
/* harmony import */ var _pipes_summary_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pipes/summary.pipe */ "./src/app/pipes/summary.pipe.ts");
...
var routes = [
    ...
    {
        path: 'movies/:id',
        component: _single_movie_single_movie_component__WEBPACK_IMPORTED_MODULE_14__["SingleMovieComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]]
    },
    {
        path: 'movies',
        component: _movie_list_movie_list_component__WEBPACK_IMPORTED_MODULE_12__["MovieListComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]]
    },
    {
        path: 'signup',
    ...
    {
        path: 'purchase',
        component: _order_ticket_order_ticket_component__WEBPACK_IMPORTED_MODULE_10__["OrderTicketComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]]
    },
    {
        path: '**',
        component: _not_found_not_found_component__WEBPACK_IMPORTED_MODULE_21__["NotFoundComponent"]
    }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
            declarations: [
                ...
                _order_ticket_order_ticket_component__WEBPACK_IMPORTED_MODULE_10__["OrderTicketComponent"],
                _login_login_component__WEBPACK_IMPORTED_MODULE_11__["LoginComponent"],
                _movie_list_movie_list_component__WEBPACK_IMPORTED_MODULE_12__["MovieListComponent"],
                _single_movie_single_movie_component__WEBPACK_IMPORTED_MODULE_14__["SingleMovieComponent"],
                _header_header_component__WEBPACK_IMPORTED_MODULE_16__["HeaderComponent"],
                _movie_cast_movie_cast_component__WEBPACK_IMPORTED_MODULE_17__["MovieCastComponent"],
                ...
                _pipes_summary_pipe__WEBPACK_IMPORTED_MODULE_20__["SummaryPipe"],
            ...
            providers: [
                _services_tmdb_service__WEBPACK_IMPORTED_MODULE_13__["TmdbService"], _services_movies_service__WEBPACK_IMPORTED_MODULE_2__["MoviesService"],
                _services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"],
                {
...
module.exports = "<div class=\"container col-sm-4 col-sm-offset-6\">\n\n  <div>\n    <img src=\"../../assets/logo-300x80.png\">\n  </div>\n  <br>\n  <br>\n  <form #f=\"ngForm\" class=\"\" (change)=\"onFormTouch()\" (ngSubmit)=\"login(f.value)\">\n    <div *ngIf=\"invalidLogin\" class=\"alert alert-danger\">\n      Invalid email and/or password.\n    </div>\n    <div class=\"form-group\">\n      <div class=\"row\">\n        <div class=\"col\">\n          <label for=\"email\">Email</label>\n          <br>\n          <input placeholder=\"*Email\" id=\"email\" #email=\"ngModel\" ngModel name=\"email\" class=\"form-control\" required>\n          <div class=\"alert alert-danger\" *ngIf=\"email.touched && email.invalid\">\n            <div *ngIf=\"email.errors.required\">\n              This field is required.\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col\">\n          <label for=\"password\">Password</label>\n          <br>\n          <input type=\"password\" placeholder=\"*Password\" ngModel name=\"password\" #password=\"ngModel\" class=\"form-control\" required>\n          <div class=\"alert alert-danger\" *ngIf=\"password.touched && password.invalid\">\n            <div *ngIf=\"password.errors.required\">\n              This field is required.\n            </div>\n          </div>\n        </div>\n\n      </div>\n\n      <br>\n      <a routerLink=\"/signup\">\n        Not registered? Sign up here!\n      </a>\n      <br>\n      <button class=\"btn btn-primary\">Log In\n      </button>\n    </div>\n  </form>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onFormTouch = function () {
...
/***/ "./src/app/movie-cast/movie-cast.component.css":
/*!*****************************************************!*\
  !*** ./src/app/movie-cast/movie-cast.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/movie-cast/movie-cast.component.html":
/*!******************************************************!*\
  !*** ./src/app/movie-cast/movie-cast.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<h3>Top Billed Cast:</h3>\n<div class=\"list-group\" *ngIf=\"cast\">\n  <div class=\"media\" *ngFor=\"let c of cast; odd as o\" [class.odd]=\"o\">\n    <a [href]=\"profileFullSize+c.profile_path\">\n      <img [src]=\"profileUrl+c.profile_path\" class=\"mr-3\" [alt]=\"c.name\">\n    </a>\n    <div class=\"media-body\">\n      {{c.name}}\n      <h5 class=\"mt-0\">\n        {{c.character}}\n      </h5>\n    </div>\n  </div>\n</div>"
...
/* harmony import */ var _services_tmdb_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../services/tmdb.service */ "./src/app/services/tmdb.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MovieCastComponent = /** @class */ (function () {
    function MovieCastComponent(tmdbService) {
        this.tmdbService = tmdbService;
        this.profileUrl = 'http://image.tmdb.org/t/p/w45';
        this.profileFullSize = 'http://image.tmdb.org/t/p/original';
    }
    MovieCastComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.tmdbService.getMovieCastByMovieId(this.id).subscribe(function (res) {
    ...
    ], MovieCastComponent.prototype, "id", void 0);
    MovieCastComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'movie-cast',
            template: __webpack_require__(/*! ./movie-cast.component.html */ "./src/app/movie-cast/movie-cast.component.html"),
            styles: [__webpack_require__(/*! ./movie-cast.component.css */ "./src/app/movie-cast/movie-cast.component.css")]
        }),
        __metadata("design:paramtypes", [_services_tmdb_service__WEBPACK_IMPORTED_MODULE_0__["TmdbService"]])
    ], MovieCastComponent);
...
/* harmony import */ var _services_orders_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../services/orders.service */ "./src/app/services/orders.service.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _services_movies_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../services/movies.service */ "./src/app/services/movies.service.ts");
...
var MovieListComponent = /** @class */ (function () {
    function MovieListComponent(orderService, movieService, authService, router) {
    ...
    MovieListComponent.prototype.isAdmin = function () {
        return this.authService.isUserAdmin();
    };
    MovieListComponent.prototype.movieAdded = function (event) {
        this.getMovies();
    };
    MovieListComponent.prototype.deleteMovie = function (id) {
        var _this = this;
        this.movieService.deleteMovieById(id).subscribe(function (response) {
            var index = _this.movieList.findIndex(function (movie) { return movie._id === response._id; });
            _this.movieList.splice(index, 1);
        });
    };
    MovieListComponent.prototype.purchaseTicket = function (movie) {
        var _this = this;
        var order = {
        ...
        this.orderService.purchaseTicket(order).subscribe(function (response) { return _this.router.navigate(['/purchase']); });
    };
    MovieListComponent.prototype.identify = function (index, item) {
        return item._id;
    };
    ...
    MovieListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_orders_service__WEBPACK_IMPORTED_MODULE_0__["OrdersService"],
...
/***/ "./src/app/order-ticket/order-ticket.component.css":
/*!*********************************************************!*\
  !*** ./src/app/order-ticket/order-ticket.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/order-ticket/order-ticket.component.html":
/*!**********************************************************!*\
  !*** ./src/app/order-ticket/order-ticket.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"text-center\">\n  <h3>\n    Congratulations!\n  </h3>\n  <h4>\n    <small>You have successfully purchased a ticket</small>\n  </h4>\n  <p>\n    In a real app, I'd be asking you for money & credit card and stuff..\n  </p>\n  <p>\n    But instead, you get a cookie!\n  </p>\n  <img class=\"img-responsive\" src=\"../../assets/cookie.jpg\" alt=\"\">\n  <br>\n  <a routerLink=\"/movies\">&#8592;Back To Movie List</a>\n</div>"

/***/ }),

/***/ "./src/app/order-ticket/order-ticket.component.ts":
/*!********************************************************!*\
  !*** ./src/app/order-ticket/order-ticket.component.ts ***!
  \********************************************************/
/*! exports provided: OrderTicketComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderTicketComponent", function() { return OrderTicketComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var OrderTicketComponent = /** @class */ (function () {
    function OrderTicketComponent() {
    }
    OrderTicketComponent.prototype.ngOnInit = function () {
    };
    OrderTicketComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-order-ticket',
            template: __webpack_require__(/*! ./order-ticket.component.html */ "./src/app/order-ticket/order-ticket.component.html"),
            styles: [__webpack_require__(/*! ./order-ticket.component.css */ "./src/app/order-ticket/order-ticket.component.css")]
        }),
        __metadata("design:paramtypes", [])
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.appendAuthHeader = function () {
        ...
        if (token)
            return new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('X-Auth-JWT', token);
        else
            return null;
    };
    AuthService.prototype.login = function (loginDetails) {
        var _this = this;
        return this.http.post(this.url, loginDetails).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            if (response['token']) {
    ...
    */
    AuthService.prototype.signup = function (signupDetails) {
        var _this = this;
        return this.http.post(this.url + "/new", signupDetails).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            if (response['token']) {
                _this.storeToken(response['token']);
                return true;
            }
    ...
    //bugged expiry dates..
    AuthService.prototype.isTokenExpired = function (millisecondsDate) {
        var date = moment__WEBPACK_IMPORTED_MODULE_4__(millisecondsDate * 1000);
        return date.isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_4__());
    };
...
var MoviesService = /** @class */ (function () {
    ...
    MoviesService.prototype.getMovies = function () {
        ...
        return this.http.get(this.url, { headers: authHeader });
    };
    MoviesService.prototype.createMovie = function (movie) {
        var authHeader = this.authService.appendAuthHeader();
        return this.http.post(this.url, movie, { headers: authHeader });
    };
    MoviesService.prototype.deleteMovieById = function (id) {
        var authHeader = this.authService.appendAuthHeader();
        return this.http.delete(this.url + "/" + id, { headers: authHeader });
    };
    MoviesService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _auth_service__WEBPACK_IMPORTED_MODULE_0__["AuthService"]])
    ], MoviesService);
...
var OrdersService = /** @class */ (function () {
    ...
    OrdersService = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]])
    ], OrdersService);
...
var TmdbService = /** @class */ (function () {
    function TmdbService(http) {
        this.http = http;
        this.key = 'api_key=d3937f004d701f1cb4c4b659a6ae6366';
        this.url = 'https://api.themoviedb.org/3/';
        this.readAccessToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMzkzN2YwMDRkNzAxZjFjYjRjNGI2NTlhNmFlNjM2NiIsInN1YiI6IjViMTY4ZGUxYzNhMzY4NTM0MjAxNTg5MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.DiWSTBYKI1zafAO74mEPIQLrJRnLks829tHUd4OsyvQ";
    }
    TmdbService.prototype.discoverPopularMovies = function () {
        return this.http.get("https://api.themoviedb.org/3/discover/movie?" + this.key + "&primaryreleasedate.gte=2016-01-01");
    };
    TmdbService.prototype.getById = function (id) {
        return this.http.get(this.url + "movie/" + id + "?" + this.key);
    };
    TmdbService.prototype.getByName = function (name) {
        var url = this.url + "search/movie?" + this.key + "&query=" + name;
        return this.http.get(url);
    };
    TmdbService.prototype.getMovieCastByMovieId = function (id) {
        return this.http.get(this.url + "movie/" + id + "/credits?" + this.key);
    };
    TmdbService.prototype.toLocalMovie = function (movie) {
        return {
            _id: "",
            tmdbId: movie.id,
            title: movie.title,
...
var SingleMovieComponent = /** @class */ (function () {
    function SingleMovieComponent(tmdbService, movieService, route) {
        this.tmdbService = tmdbService;
        this.movieService = movieService;
        this.route = route;
        this.posterUrl = 'http://image.tmdb.org/t/p/w500';
        this.profileFullSize = 'http://image.tmdb.org/t/p/original';
        this.backdropUrl = 'http://image.tmdb.org/t/p/original';
    }
    ...
    SingleMovieComponent.prototype.getMovie = function () {
        var _this = this;
        this.tmdbService.getById(this.id).subscribe(function (response) {
            _this.movie = response;
            _this.backdropPath = "url(" + (_this.backdropUrl + response['backdrop_path']) + ")";
        });
    };
    SingleMovieComponent.prototype.getMovieCast = function () {
        var _this = this;
        this.tmdbService.getMovieCastByMovieId(this.id).subscribe(function (response) {
            _this.cast = response['cast'].slice(0, 5);
        });
    };
    SingleMovieComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_tmdb_service__WEBPACK_IMPORTED_MODULE_2__["TmdbService"], _services_movies_service__WEBPACK_IMPORTED_MODULE_0__["MoviesService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
...
module.exports = __webpack_require__(/*! D:\Work\angular\Fixel\fixel-front\src\main.ts */"./src/main.ts");
